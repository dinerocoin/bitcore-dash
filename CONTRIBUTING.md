# Contributing to Bitcore-Dinero

We're working hard to make *bitcore-dinero* the most powerful JavaScript library for working with Dinero. Our goal is to have *bitcore-dinero* be a library that can be used by anyone interested in Dinero, and to level expertise differences with great design and documentation.
...
These are some global design goals in bitcore-dinero to which any change should adhere.
...
```sh
git remote add dinero git@github.com:dinerocoin/bitcore-dinero.git
git pull --rebase dinero master
```
...
```
Finally go to [github.com/dinerocoin/bitcore-dinero](https://github.com/dinerocoin/bitcore-dinero) in your web browser and issue a new pull request.
...
[github.com/dinerocoin/bitcore-dinero/issues](https://github.com/dinerocoin/bitcore-dinero/issues).
